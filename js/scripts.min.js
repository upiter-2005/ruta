...
$(function() {
	...
	$('.owl-serv').owlCarousel({
		...
		loop:true,
		margin:10,
		navText : ["","<img src='http://ruta.zelengood.com/wp-content/themes/ruta/img/arr-left.svg'>"],
		nav: true,
		dots: true,
		animateOut: 'fadeOut',
		mouseDrag: false,
		...
		responsive:{
			0:{
				items:1,
				navText : ["<img src='http://ruta.zelengood.com/wp-content/themes/ruta/img/arr-left.svg'>","<img src='http://ruta.zelengood.com/wp-content/themes/ruta/img/arr-right2.svg'>"],
			},
			600:{
				items:2
			},
